...
public class binaryToHex {
	...
	public static void main(String[] args) {
		...
		if(decimal_representation < 16)
			System.out.println("The 1 digit hex representation is " + hex_representation);
		else
			System.out.println("The 2 digit hex representation is " + get2DigitHex(binary_input));
	}
}
